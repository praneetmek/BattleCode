    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        while (true) {
            ...
            try {
                ...
                //if the robot sees an archon, go store it in the array
                ...
                for (RobotInfo robotInfo : nearbyEnemies) {
                    ...
                    if(!Communication.isFrontLine(rc)) {
                      ...
                      if(distanceToSoldier<distanceToFrontLine){
                ...
                switch (rc.getType()) {
                    ...
                    case MINER:
                        ...
                        break;
                    case SOLDIER:
                        SoldierStrategy.runSoldier(rc, nearbyEnemies);
                        break;
                    case LABORATORY: // Examplefuncsplayer doesn't use any of these robot types below.
                    case WATCHTOWER: // You might want to give them a try!
                    case BUILDER :
                            BuilderStrategy.runBuilder(rc);
                    case SAGE:
                        break;
                }
